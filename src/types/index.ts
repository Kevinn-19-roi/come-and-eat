...
export interface Product { id: ID; sku: string; name: string; slug: string; categoryId: ID; price: number; description: string; image?: Media; available: boolean; optionGroupIds: ID[]; archived?: boolean }
